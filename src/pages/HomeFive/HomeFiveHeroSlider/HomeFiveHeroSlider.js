          ...
          <Slider className="slider-active" {...settings}>
            {sliderData.map((slider, index) => {
              return (
                <div
                  key={index}
                  className="single-slider h4slider-bg h5slider_bg pos-rel d-flex align-items-center
                           ps-55"
                >
                        ...
                        <div className="hero-text">
                          <div className="hero-slider-caption h4hero-content mb-35">
                            ...
                            <p className="white-color">
                              ...
                              but because those who do not know how rationally
                              encounter consequences that extremely system
                              weathe.
                            </p>
