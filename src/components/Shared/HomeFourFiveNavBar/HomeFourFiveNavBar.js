              ...
              <div className="col-xl-6 col-lg-6">
                <div className="header-info header-info4 p-0">
                  <span>
                    ...
                    fatmazehra.kermalli@gmail.com
                  </span>
                  <span>
                    <i className="fal fa-phone"></i>+905346213899
                  </span>
                  <span>
                    <i className="fal fa-clock"></i>Hafta içi Her gün, 09:00 -
                    17:00
                  </span>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-xl-8 col-lg-12 col-md-12 d-flex align-items-center navbar__wrapper">
                <div className="logo pos-rel">
                  <Link to="/">
                    <img src="img/logo/logo-4.png" alt="MediDove" />
                  </Link>
                </div>
